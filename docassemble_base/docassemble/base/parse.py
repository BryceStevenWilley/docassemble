                    ...
                    if 'show_if_js' in field.extras:
                        ...
                        if the_expression != '':
                            ...
                            if field.extras['show_if_js'].get('is_python'):
                                the_expression = transform_string(the_expression)
                            field.extras['show_if_js']['vars'] = process_js_vars(re.findall(r'(?:val|getField|daGetField)\(\'([^\)]+)\'\)', the_expression) + re.findall(r'(?:val|getField|daGetField)\("([^\)]+)"\)', the_expression))
